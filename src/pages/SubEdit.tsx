...
import './SubEdit.css'; // Uvozimo CSS za dodatno oblikovanje
            ...
            <div className="row justify-content-center">
                <div className="col-lg-6 col-md-8 col-sm-10">
                    <form onSubmit={submit} className="form-container">
                        <h2 className="text-center mb-4">Posodobi izdelek</h2>
                        ...
                        <button type="submit" className="btn btn-primary w-100">Posodobi izdelek</button>
